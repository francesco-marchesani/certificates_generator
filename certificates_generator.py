...
name = raw_input('\nWrite your name (e.g., Mario)\n')
surname = raw_input('\nWrite your surname (e.g., Rossi)\n')
city = raw_input('\nWrite the city where you were born (e.g., Milano)\n')
day_of_birth = raw_input('\nWrite the day where you were born (e.g., 10)\n')
month_of_birth = raw_input('\nWrite the month where you were born (e.g., 03)\n')
year_of_birth = raw_input('\nWrite the year where you were born (e.g., 1990)\n')
country_of_birth = raw_input('\nWrite the country where you were born (e.g., Italy)\n')
